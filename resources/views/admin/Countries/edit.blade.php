...
@section('title')
    <title>@lang('text.CountryTitleEdit')</title>
@endsection
@section('main')
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title {{app()->getLocale() != "fa" ? "" : "text-right"}}">@lang('text.CountryTitleEdit')</h4>
                        <form class="forms-sample" method="post"
                              action="{{route('country.update',['country'=>$data['country']->id])}}"
