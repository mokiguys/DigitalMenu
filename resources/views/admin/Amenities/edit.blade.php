    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title {{app()->getLocale() != "fa" ? "" : "text-right"}}">@lang('text.AmenitiesTitleEdit')</h4>
                        <form class="forms-sample" method="post"
                              action="{{route('amenities.update',['amenity'=>$data['amenities']->id])}}"
