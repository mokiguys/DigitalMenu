...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'image' => 'عکس',
        'alt' => 'متن جایگزین',
        'title_image' => 'عنوان عکس',
        'fullName' => 'نام و نام خانوادگی',
        'g-recaptcha-response' => 'من ربات نیستم',
        'subject' => 'موضوع',
        'short_text' => 'توضیح کوتاه',
        'post_type' => 'نوع فعالیت پرسنل',
        'name_fa' => 'نام (فارسی)',
        'name_en' => 'نام (انگلیسی)',
        'text_en' => 'توضیح (انگلیسی)',
        'text_fa' => 'توضیح (فارسی)',
        'post_fa' => 'سِمَت شغلی (فارسی)',
        'post_en' => 'سِمَت شغلی (انگلیسی)',
        'status_project' => 'وضعیت پروژه',
        'short_text_en' => 'توضیح کوتاه (انگلیسی)',
        'short_text_fa' => 'توضیح کوتاه (فارسی)',
